...
OUT = r"C:\Users\rishi\Downloads\public_safety_hackathon_site\public_safety_hackathon_final\documentation\Lifeline_Prompt_Aligned_Code_Presentation.docx"

script = (
    "Lifeline responds to the main prompt's central problem: a person may become unable to ask for help. "
...
files = [
    ...
    ("about.html", "Working features, limitations, privacy, and unsupported claims", "Reinforces that Lifeline detects risk patterns, not substances"),
...
doc.add_paragraph("Lifeline Code and Prompt Relevance", style="Title")
...
doc.core_properties.title = "Lifeline Code and Prompt Relevance"
